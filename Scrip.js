...
var Rutas = {
    ...
    Ruta10_Vuelta: {
        ...
        paradas: [
            { coordenadas: { lat: -16.403736, lng: -71.547759 }, nombre: 'Ricardo Palma, Arequipa 04013' },
            { coordenadas: { lat: -16.404374, lng: -71.543042 }, nombre: 'Salaverry 607-601, Arequipa 04001' },
            { coordenadas: { lat: -16.405660, lng: -71.542283 }, nombre: 'Av. Luna Pizarro 401, Arequipa 04001' },
            { coordenadas: { lat: -16.408707, lng: -71.541102 }, nombre: 'C. Angamos 103, Arequipa 04001' },
            { coordenadas: { lat: -16.407125, lng: -71.539192 }, nombre: 'Salaverry, Arequipa 04001' },
            { coordenadas: { lat: -16.408299, lng: -71.538196 }, nombre: 'Av. Mariscal Cáceres 114-132, Arequipa 04001' },
            { coordenadas: { lat: -16.410193, lng: -71.536186 }, nombre: 'Mal. Socabaya 107-131, Arequipa 04001' },
            { coordenadas: { lat: -16.413341, lng: -71.535068 }, nombre: 'Alcides Carrión, Arequipa 04002' },
            { coordenadas: { lat: -16.415582, lng: -71.534069 }, nombre: 'Av. Daniel Alcides Carrión, Arequipa 04002' },
            { coordenadas: { lat: -16.421310, lng: -71.531340 }, nombre: 'Av. Daniel Alcides Carrión 206-196, Arequipa 04002' },
            { coordenadas: { lat: -16.425094, lng: -71.533336 }, nombre: 'Av. Daniel Alcides Carrión, José Luis Bustamante y Rivero 04002' },
            { coordenadas: { lat: -16.430359, lng: -71.534402 }, nombre: 'HF98+R7M, Av. Vidaurrazaga, Arequipa 04009' },
            { coordenadas: { lat: -16.429743, lng: -71.526694 }, nombre: 'Av. Estados Unidos, Arequipa 04009' },
            { coordenadas: { lat: -16.427296, lng: -71.518592 }, nombre: 'Av. Hartley 122, José Luis Bustamante y Rivero 04009' },
            { coordenadas: { lat: -16.425082, lng: -71.513470 }, nombre: 'Av. Guardia Civil, Arequipa Metropolitana 04009' },
            { coordenadas: { lat: -16.423293, lng: -71.509753 }, nombre: '34C, Arequipa 04009' },
            { coordenadas: { lat: -16.422306, lng: -71.507636 }, nombre: '35C, Arequipa 04009' },
            { coordenadas: { lat: -16.424746, lng: -71.505882 }, nombre: 'John F. Kennedy 1800, Paucarpata 04009' },
            { coordenadas: { lat: -16.429367, lng: -71.496306 }, nombre: 'Av. Cristo Rey, Arequipa 04008' },
            { coordenadas: { lat: -16.429310, lng: -71.491165 }, nombre: '04002, Paucarpata 04000' }
        ],
        recorrido: 'Vuelta',
        nombre: 'Ruta10'
    },
    ...
    Ruta11_Ida: {
        ...
        paradas: [
            { coordenadas: { lat: -16.359427, lng: -71.509089 }, nombre: 'Asoc el Mirador de Arequipa Zona B, Arequipa 04003' },
            { coordenadas: { lat: -16.362028, lng: -71.513599 }, nombre: 'El Mirador de Arequipa, Arequipa 04003' },
            { coordenadas: { lat: -16.364530, lng: -71.515414 }, nombre: 'C. 7, Arequipa 04003' },
            { coordenadas: { lat: -16.367270, lng: -71.519366 }, nombre: 'C. Elias Aguirre 645-585, Arequipa 04003' },
            { coordenadas: { lat: -16.368882, lng: -71.519305 }, nombre: 'A.h Villa Independiente Zona B, Arequipa 04003' },
            { coordenadas: { lat: -16.371222, lng: -71.516691 }, nombre: 'Leticia 803, Alto Selva Alegre 04003' },
            { coordenadas: { lat: -16.374671, lng: -71.522629 }, nombre: 'Av. las Torres 13, Alto Selva Alegre 04003' },
            { coordenadas: { lat: -16.378040, lng: -71.524532 }, nombre: 'Pl. Mayor de Alto Selva Alegre, Arequipa 04003' },
            { coordenadas: { lat: -16.378157, lng: -71.521353 }, nombre: 'Coop Ramiro Priale Priale, Arequipa 04003' },
            { coordenadas: { lat: -16.379410, lng: -71.520118 }, nombre: 'C. Los Andes 1003, Alto Selva Alegre 04003' },
            { coordenadas: { lat: -16.383255, lng: -71.524638 }, nombre: 'Av. Roosevelt 711, Alto Selva Alegre 04001' },
            { coordenadas: { lat: -16.389452, lng: -71.526704 }, nombre: 'Av. Arequipa 223-209, Alto Selva Alegre 04001' },
            { coordenadas: { lat: -16.394248, lng: -71.521652 }, nombre: 'Miraflores' },
            { coordenadas: { lat: -16.396579, lng: -71.518624 }, nombre: 'Av. Progreso 984, Arequipa 04001' },
            { coordenadas: { lat: -16.400129, lng: -71.520316 }, nombre: 'Av. Mariscal Castilla 255, Miraflores 04001' },
            { coordenadas: { lat: -16.402356, lng: -71.525069 }, nombre: 'Av. Independencia 424, Arequipa 04001' },
            { coordenadas: { lat: -16.408386, lng: -71.532386 }, nombre: 'Av. Independencia 1438-1554, Arequipa 04001' },
            { coordenadas: { lat: -16.416374, lng: -71.533496 }, nombre: 'Alcides Carrión 177-178, Arequipa 04002' },
            { coordenadas: { lat: -16.420565, lng: -71.539217 }, nombre: 'HFH6+Q8F José Luis Bustamante y Rivero' },
            { coordenadas: { lat: -16.423038, lng: -71.542801 }, nombre: '34C, Jacobo Hunter 04011' }
        ],
        recorrido: 'Ida',
        nombre: 'Ruta11'
    },
    ...
    Ruta11_Vuelta: {
        ...
        paradas: [
            { coordenadas: { lat: -16.4223778, lng: -71.5440237 }, nombre: 'HFH4+29X José Luis Bustamante y Rivero' },
            { coordenadas: { lat: -16.4215858, lng: -71.5414179 }, nombre: 'Arequipa' },
            { coordenadas: { lat: -16.4163267, lng: -71.5332190 }, nombre: 'Arequipa 04002' },
            { coordenadas: { lat: -16.4133469, lng: -71.5348413 }, nombre: 'Av. Daniel Alcides Carrion, Arequipa' },
            { coordenadas: { lat: -16.4117572, lng: -71.5344432 }, nombre: 'Av. Virgen del Pilar, Arequipa 04002' },
            { coordenadas: { lat: -16.4109596, lng: -71.5333157 }, nombre: 'Av. Virgen del Pilar, Sedapar, Arequipa 04002' },
            { coordenadas: { lat: -16.4057026, lng: -71.5289640 }, nombre: 'Urb. La Perla, Arequipa 04001' },
            { coordenadas: { lat: -16.4044569, lng: -71.5274436 }, nombre: 'Av. Independencia 803, Arequipa 04001' },
            { coordenadas: { lat: -16.4058452, lng: -71.5221469 }, nombre: 'Vía Rápida Venezuela, Arequipa 04002' },
            { coordenadas: { lat: -16.4053539, lng: -71.5212372 }, nombre: 'Vía Rápida Venezuela, Arequipa 04002' },
            { coordenadas: { lat: -16.3934125, lng: -71.5224761 }, nombre: 'Av. Progreso 603, Miraflores 04004' },
            { coordenadas: { lat: -16.3887705, lng: -71.5262105 }, nombre: '1 de Mayo 110, Alto Selva Alegre 04001' },
            { coordenadas: { lat: -16.3786713, lng: -71.5232247 }, nombre: 'Alcala, Lima 04003' },
            { coordenadas: { lat: -16.3782878, lng: -71.5240210 }, nombre: 'Mz L, Lote1 Pampa de Polanco, Javier Heraud, Alto Selva Alegre 04003' },
            { coordenadas: { lat: -16.3779285, lng: -71.5245938 }, nombre: 'Calle 2, Arequipa 04003' },
            { coordenadas: { lat: -16.3796659, lng: -71.5266417 }, nombre: 'Coop Villa Arequipa, Arequipa 04003' },
            { coordenadas: { lat: -16.3784089, lng: -71.5277752 }, nombre: 'Coop Villa el Conquistador Etapa 1, Arequipa 04003' },
            { coordenadas: { lat: -16.3714912, lng: -71.5166505 }, nombre: 'Leticia, Arequipa 04003' }
        ],
        recorrido: 'Vuelta',
        nombre: 'Ruta11'
    },
