...
function toggleRuta(ruta) {
    ...
    if (checkBox.checked) {
        if (ruta === 'Ruta1') {
            ...
            mostrarRuta(solicitud2Ruta1,"blue", "Ruta1", paradasAutobus2);
        } else if (ruta === 'Ruta2') {
            mostrarRuta2();
        } else if (ruta === 'Ruta3') {
            mostrarRuta3();
...
function mostrarRuta3() {
    var puntoInicio = { lat: -16.376844, lng: -71.498962 };
    var puntoDestino = { lat: -16.376844, lng: -71.498962 };
    ...
    agregarRuta(solicitud3, 'green', paradasAutobus, 'Ruta3');
}

function mostrarRuta4() {
    var puntoInicio = { lat: -16.365747, lng: -71.501906 };
    var puntoDestino = { lat: -16.408259, lng: -71.542062 };
    ...
    agregarRuta(solicitud4_1, 'green', paradasAutobus1, 'Ruta4');
    agregarRuta(solicitud4_2, 'blue', paradasAutobus2, 'Ruta4');
}

function mostrarRuta5() {
    var puntoInicio = { lat: -16.37982, lng: -71.49182 };
    var puntoDestino = { lat: -16.42560, lng: -71.53457 };
    ...
    agregarRuta(solicitud5_1, 'green', paradasAutobus1, 'Ruta5');
    agregarRuta(solicitud5_2, 'blue', paradasAutobus2, 'Ruta5');
}

function mostrarRuta6() {
    var puntoInicio = { lat: -16.376844, lng: -71.498962 };
    var puntoDestino = { lat: -16.376844, lng: -71.498962 };
    ...
    agregarRuta(solicitud6, 'green', paradasAutobus1, 'Ruta6');
    agregarRuta(solicitud6, 'green', paradasAutobus2, 'Ruta6');
}

function mostrarRuta9() {
    var puntoInicio = { lat: -16.46169, lng: -71.52431 };
    var puntoDestino = { lat: -16.39400, lng: -71.50296 };
    ...
    agregarRuta(solicitud9_1, 'green', paradasAutobus1, 'Ruta9');
    agregarRuta(solicitud9_2, 'blue', paradasAutobus2, 'Ruta9');
}

function mostrarRuta10() {
    var puntoInicio = { lat: -16.42929, lng: -71.491115 };
    var puntoDestino = { lat: -16.40194, lng: -71.54705 };
    ...
    agregarRuta(solicitud10_1, 'green', paradasAutobus1, 'Ruta10');
    agregarRuta(solicitud10_2, 'blue', paradasAutobus2, 'Ruta10');
}

function mostrarRuta11() {
    var puntoInicio = { lat: -16.359427, lng: -71.509089 };
    var puntoDestino = { lat: -16.423153, lng: -71.542591 };
    ...
    agregarRuta(solicitud11, 'green', paradasAutobus, 'Ruta11');
}

function mostrarRuta12() {
    var puntoInicio = { lat: -16.403476, lng: -71.494438 };
    var puntoDestino = { lat: -16.407710, lng: -71.533938 };
    ...
    agregarRuta(solicitud12_1, 'green', paradasAutobus1, 'Ruta12');
    agregarRuta(solicitud12_2, 'blue', paradasAutobus2, 'Ruta12');
}


function mostrarRuta13() {
    var puntoInicio = { lat: -16.337710, lng: -71.552126 };
    var puntoDestino = { lat: -16.406574, lng: -71.530123 };
    ...
    agregarRuta(solicitud13_1, 'green', paradasAutobus1, 'Ruta13');
    agregarRuta(solicitud13_2, 'blue', paradasAutobus2, 'Ruta13');
}

function mostrarRuta14() {
    var puntoInicio = { lat: -16.461711, lng: -71.524362 };
    var puntoDestino = { lat: -16.389966, lng: -71.547015 };
    ...
    agregarRuta(solicitud14_1, 'green', paradasAutobus1, 'Ruta14');
    agregarRuta(solicitud14_2, 'blue', paradasAutobus2, 'Ruta14');
}

function mostrarRuta15() {
    var puntoInicio = { lat: -16.41492, lng: -71.49246 };
    var puntoDestino = { lat: -16.40588, lng: -71.53165 };
    ...
    agregarRuta(solicitud15_1, 'green', paradasAutobus1, 'Ruta15');
    agregarRuta(solicitud15_2, 'blue', paradasAutobus2, 'Ruta15');
}

function mostrarRuta16() {
    var puntoInicio = { lat: -16.416442, lng: -71.481015 };
    var puntoDestino = { lat: -16.422519, lng: -71.544020 };
    ...
    agregarRuta(solicitud16_1, 'green', paradasAutobus1, 'Ruta16');
    agregarRuta(solicitud16_2, 'blue', paradasAutobus2, 'Ruta16');
}

function mostrarRuta17() {
    var puntoInicio = { lat: -16.457464, lng: -71.553470 };
    var puntoDestino = { lat: -16.404315, lng: -71.527522 };
    ...
    agregarRuta(solicitud17_1, 'green', paradasAutobus1, 'Ruta17');
    agregarRuta(solicitud17_2, 'blue', paradasAutobus2, 'Ruta17');
}

function mostrarRuta18() {
    var puntoInicio = { lat: -16.424818, lng: -71.672601 };
    var puntoDestino = { lat: -16.424818, lng: -71.672601 };
    ...
    agregarRuta(solicitud18_1, 'green', paradasAutobus1, 'Ruta18');
    agregarRuta(solicitud18_1, 'blue', paradasAutobus2, 'Ruta18');
}
...
/*
function obtenerCoordenadasDeParaderos(ruta) {
    if (marcadores[ruta] && marcadores[ruta].length > 0) {
        marcadores[ruta].forEach(function (marcador, index) {
            ///var position = marcador.getPosition();
            var lat = marcador.lat;
            var lng = marcador.lng;
            console.log('Marcador ' + index + ' - Latitud: ' + lat + ', Longitud: ' + lng);
        });
    } else {
        console.log('No se encontraron marcadores para la ruta ' + ruta);
    }
}*/
